...
export default function SimpleTable({
    ...
    return (
        <div className="w-full gap-4 px-4 py-3">
            <header className="mb-2 flex-between">
                {title}
                {collection?.length > 0 && (
                        ...
                        {columns.map((column, i) => {
                            const getHeaderAlignment = () => {
                                if (
                                    ...
                                    return "flex-start";
                                if (column.headerAlignment === "center")
                                    return "flex-center";
                                if (column.headerAlignment === "right")
                                    return "flex-end";
                            };
                            return (
                                <th
                                    key={i}
                                    className="px-2 py-2 text-sm font-normal first:pl-4 last:pr-4"
                                >
                                    <p
